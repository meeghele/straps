...
Straps provides **84 functions** organized into 10 categories for comprehensive system testing and validation.
...
- `can_connect_to(host, port, protocol)` - Test network connectivity (TCP/UDP)
...
- **Docker/Container**: Covered in `test_edge_cases.bats` with mock validation
...
- **Network Extended**: Protocol validation in `test_network.bats`
